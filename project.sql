...
CREATE TABLE films_act_dir (film_id INT, actor_director_id INT, role VARCHAR(20), PRIMARY KEY (film_id, actor_director_id),
...
INSERT INTO films (name, country, relese_day) VALUES ('Alien', 'USA', '1979-02-10');
			INSERT INTO films_act_dir (film_id, actor_director_id, role) VALUES (1, 1, 'Actor');
            INSERT INTO films_act_dir (film_id, actor_director_id, role) VALUES (1, 2, 'Director');

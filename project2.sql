...
CREATE TABLE actors_directors (id INT AUTO_INCREMENT,first_name VARCHAR(50), last_name VARCHAR(50), birthday DATE,role VARCHAR(20),PRIMARY KEY(id));
...
INSERT INTO actors_directors (first_name, last_name, birthday,role) VALUES ('Sigurni', 'Uiver', '1959-07-10','Actor');
INSERT INTO actors_directors (first_name, last_name, birthday,role) VALUES ('Ridli', 'Skot', '1945-11-28','Director');
